...
class CMB2_Types {
	...
	public function parse_args( $args, $element, $defaults ) {
		return wp_parse_args( apply_filters( "cmb2_{$element}_attributes", $this->field->mayCC_set_attributes( $args ), $defaults, $this->field, $this ), $defaults );
	}
	...
	public function text_datetime_timestamp_timezone( $args = array() ) {
		...
		$datetime = mayCC_unserialize( $args['value'] );
		$value = $tzstring = '';
